...
namespace Lab_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //+ 4.Если хотя бы один из коэффициентов А, В, С введен некорректно, 
            //  то программа должна сообщить об ошибке(цвет шрифта красный и позволить и ввести коэффициент повторно.
